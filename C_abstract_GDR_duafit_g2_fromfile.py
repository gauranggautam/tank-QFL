...
print('cwd',os.getcwd()) 
#input_dir = r'C:\Users\gauta\OneDrive\Desktop\Data_poster'
#output_dir = r'C:\Users\gauta\OneDrive\Desktop\Data_poster'
input_dir = r'D:\Apaquette\input'
output_dir = r'D:\APaquette\Output g2'
os.makedirs(output_dir, exist_ok=True)
os.getcwd() 
filesstring = [os.path.join(input_dir, f) for f in os.listdir(input_dir) if f.endswith('.ptu')]

d=binsize= 600  #in ps
c=windowsize=600000#binsize*100 #in ps
