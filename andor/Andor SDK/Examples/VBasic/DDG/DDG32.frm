...
Begin VB.Form Form1 
   ...
   Begin VB.TextBox ebPulseWidth 
      ...
      Width           =   972
   End
   Begin VB.CommandButton pbFindPulse 
      Caption         =   "&Find Pulse"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
...
'scans. It demonstrates the use of the Digital Delay Generator functions
'which can be used with Istar systems.
'
'The user may specify the exposure and kinetic cycle times,
...
'**************************************************************
  ...
  PrintStatusMsg ("* KINETICS MODE * FVB SCANS")
  cmbTrigger.ListIndex = 0
...
'**************************************************************************
  ...
  If (vbSetGain = LOCALERROR) Then
    ...
    Exit Function
  End If
  If (vbSetDDGTrigger = LOCALERROR) Then
    vbSetDDG = LOCALERROR
    Exit Function
  End If
