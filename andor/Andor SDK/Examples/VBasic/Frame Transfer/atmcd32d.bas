...
Declare Function EnableSensorCompensation Lib "atmcd32d.dll" (ByVal iMode As Long) As Long
Declare Function SetIRIGModulation Lib "atmcd32d.dll" (ByVal mode As String) As Long
...
Declare Function GetBitsPerPixel Lib "atmcd32d.dll" (ByVal readout_index As Long, ByVal index As Long, value As Long) As Long
...
Declare Function GetESDEventStatus Lib "atmcd32d.dll" (camStatus As Long) As Long
...
' Declare Function GetNumberMissedExternalTriggers Lib "atmcd32d.dll" (ByVal first As Long, ByVal last As Long, arr As Integer, ByVal size As Long) As Long
Declare Function GetIRIGData Lib "atmcd32d.dll" (_uc_irigData As Byte, ByVal _ui_index As Long) As Long
Declare Function GetMetaData Lib "atmcd32d.dll" (data As Byte, ByVal _ui_index As Long) As Long
...
Declare Function GetCurrentPreAmpGain Lib "atmcd32d.dll" (index As Long, ByVal name As String, ByVal length As Long) As Long
...
Declare Function GetTemperaturePrecision Lib "atmcd32d.dll" (precision As Long) As Long
...
' Declare Function GetUSBDeviceDetails Lib "atmcd32d.dll" (VendorID As Integer, ProductID As Integer, FirmwareVersion As Integer, SpecificationNumber As Integer) As Long
...
Declare Function IsReadoutFlippedByAmplifier Lib "atmcd32d.dll" (ByVal iAmplifier As Long, iFlipped As Long) As Long
Declare Function IsTriggerModeAvailable Lib "atmcd32d.dll" (ByVal iTriggerMode As Long) As Long
Declare Function LoadEEPROM Lib "atmcd32d.dll" (ByVal eepromFile As String) As Long
...
Declare Function SaveAsCalibratedSif Lib "atmcd32d.dll" (ByVal path As String, ByVal x_data_type As Long, ByVal x_unit As Long, x_cal As Single, ByVal rayleighWavelength As Single) As Long
...
Declare Function SetSensorPortMode Lib "atmcd32d.dll" (ByVal mode As Long) As Long
Declare Function SelectSensorPort Lib "atmcd32d.dll" (ByVal port As Long) As Long
Declare Function SetSizeOfCircularBufferMegaBytes Lib "atmcd32d.dll" (ByVal sizeMB As Long) As Long
Declare Function SelectDualSensorPort Lib "atmcd32d.dll" (ByVal port As Long) As Long
...
Declare Function SetBitsPerPixel Lib "atmcd32d.dll" (ByVal state As Long) As Long
...
Declare Function SetESDEvent Lib "atmcd32d.dll" (ByVal esdEvent As Long) As Long
...
Declare Function SetFastKineticsStorageMode Lib "atmcd32d.dll" (ByVal mode As Long) As Long
Declare Function SetFastKineticsTimeScanMode Lib "atmcd32d.dll" (ByVal rows As Long, ByVal tracks As Long, ByVal mode As Long) As Long
...
Declare Function SetIsolatedCropModeType Lib "atmcd32d.dll" (ByVal type As Long) As Long
Declare Function SetKeepCleanMode Lib "atmcd32d.dll" (ByVal mode As Long) As Long
...
Declare Function SetOverTempEvent Lib "atmcd32d.dll" (ByVal tempEvent As Long) As Long
...
Declare Function UpdateDDGTimings Lib "atmcd32d.dll" () As Long
...
Declare Function OA_IsPreSetModeAvailable Lib "atmcd32d.dll" (pcModeName As String) As Long
...
Global Const DRV_USB_INTERRUPT_ENDPOINT_TIMEOUT = 20102
...
Global Const DRV_OA_CAMERA_NOT_AVAILABLE = 20196
...
Global Const AC_ACQMODE_TDI = &H80
...
Global Const AC_TRIGGERMODE_EXTERNAL_RISING = &H0100
Global Const AC_TRIGGERMODE_EXTERNAL_PURGE = &H0200
...
Global Const AC_CAMERATYPE_IVAC_CCD = 23
Global Const AC_CAMERATYPE_ASPEN = 24
Global Const AC_CAMERATYPE_ASCENT = 25
Global Const AC_CAMERATYPE_ALTA = 26
Global Const AC_CAMERATYPE_ALTAF = 27
Global Const AC_CAMERATYPE_IKONXL = 28
Global Const AC_CAMERATYPE_CMOS_GEN2 = 29
Global Const AC_CAMERATYPE_ISTAR_SCMOS = 30
Global Const AC_CAMERATYPE_IKONLR = 31
...
Global Const AC_SETFUNCTION_SUPERKINETICS = &H20000000
Global Const AC_SETFUNCTION_TIMESCAN = &H40000000
Global Const AC_SETFUNCTION_CROPMODETYPE = &H80000000
...
Global Const AC_FEATURES_FIFOFULL_EVENT = &H10000000
Global Const AC_FEATURES_SENSOR_PORT_CONFIGURATION = &H20000000
Global Const AC_FEATURES_SENSOR_COMPENSATION = &H40000000
Global Const AC_FEATURES_IRIG_SUPPORT = &H80000000
...
Global Const AC_FEATURES2_ESD_EVENTS = 1
Global Const AC_FEATURES2_DUAL_PORT_CONFIGURATION = 2
Global Const AC_FEATURES2_OVERTEMP_EVENTS = 4
