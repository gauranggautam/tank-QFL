...
Begin VB.Form Form1 
   BackColor       =   &H00808000&
   Caption         =   "Instaspec Visual Basic Example Drivers:- Kinetic Series"
   ClientHeight    =   6765
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8295
...
'AND the number of scans in the series.
...
'****************************************************************
'Get actual Exposure and cycle times used by InstaSpec.  InstaSpec
...
'**************************************************************
' Configure InstaSepc to operate in Kinetics mode.
'**************************************************************
...
'**************************************************************
' Configure InstaSpec to Full Vertical Binning.
'**************************************************************
...
Function vbStartAcq()
'******************************************************************
' Tells InstaSpec to begin Acquisition upon receipt of an Internal
' trigger pulse.
'******************************************************************
...
'*********************************************************************
'This function assumes the array containing the InstaSpec data,
...
'store the InstaSpec data.  The InstaSpec Visual Basic Example Drivers: Image
...
'*************************************************************************************
'This routine is the heart of the Kinetics application.  It configures the InstaSpec
