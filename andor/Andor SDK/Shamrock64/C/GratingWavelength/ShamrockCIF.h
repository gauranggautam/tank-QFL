...
#define SHAMROCK_SHUTTERMODEMAX 2
...
//SDK Focus Mirror Tilt functions
unsigned int WINAPI ShamrockFocusMirrorTiltIsPresent(int device, int *present);
unsigned int WINAPI ShamrockSetFocusMirrorTilt(int device, int tilt);
unsigned int WINAPI ShamrockGetFocusMirrorTilt(int device, int *tilt);
unsigned int WINAPI ShamrockSetFocusMirrorTiltOffset(int device,int entrancePort, int exitPort, int offset);
unsigned int WINAPI ShamrockGetFocusMirrorTiltOffset(int device, int entrancePort, int exitPort, int *offset);

unsigned int WINAPI ShamrockMoveTurretToSafeChangePosition(int device);
