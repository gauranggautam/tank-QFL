...
Declare Function EnableSensorCompensation Lib "atmcd32d.dll" (ByVal iMode As Long) As UInteger
Declare Function SetIRIGModulation Lib "atmcd32d.dll" (ByVal mode As Byte) As UInteger
...
Declare Function GetBitsPerPixel Lib "atmcd32d.dll" (ByVal readout_index As Integer, ByVal index As Integer, ByRef value As Integer) As UInteger
...
Declare Function GetESDEventStatus Lib "atmcd32d.dll" (ByRef camStatus As Integer) As UInteger
...
Declare Function GetNumberMissedExternalTriggers Lib "atmcd32d.dll" (ByVal first As Integer, ByVal last As Integer, ByRef arr As Integer, ByVal size As Integer) As UInteger
Declare Function GetIRIGData Lib "atmcd32d.dll" (ByRef _uc_irigData As Byte, ByVal _ui_index As Integer) As UInteger
Declare Function GetMetaData Lib "atmcd32d.dll" (ByRef data As Byte, ByVal _ui_index As Integer) As UInteger
...
Declare Function GetCurrentPreAmpGain Lib "atmcd32d.dll" (ByRef index As Integer, ByVal name As String, ByVal length As Integer) As UInteger
...
Declare Function GetTemperaturePrecision Lib "atmcd32d.dll" (ByRef precision As Integer) As UInteger
...
Declare Function GetUSBDeviceDetails Lib "atmcd32d.dll" (ByRef VendorID As Integer, ByRef ProductID As Integer, ByRef FirmwareVersion As Integer, ByRef SpecificationNumber As Integer) As UInteger
...
Declare Function IsReadoutFlippedByAmplifier Lib "atmcd32d.dll" (ByVal iAmplifier As Integer, ByRef iFlipped As Integer) As UInteger
Declare Function IsTriggerModeAvailable Lib "atmcd32d.dll" (ByVal iTriggerMode As Integer) As UInteger
Declare Function LoadEEPROM Lib "atmcd32d.dll" (ByVal eepromFile As String) As UInteger
...
Declare Function SaveAsCalibratedSif Lib "atmcd32d.dll" (ByVal path As String, ByVal x_data_type As Integer, ByVal x_unit As Integer, ByRef x_cal As Single, ByVal rayleighWavelength As Single) As UInteger
...
Declare Function SetSensorPortMode Lib "atmcd32d.dll" (ByVal mode As Integer) As UInteger
Declare Function SelectSensorPort Lib "atmcd32d.dll" (ByVal port As Integer) As UInteger
Declare Function SetSizeOfCircularBufferMegaBytes Lib "atmcd32d.dll" (ByVal sizeMB As Integer) As UInteger
Declare Function SelectDualSensorPort Lib "atmcd32d.dll" (ByVal port As Integer) As UInteger
...
Declare Function SetBitsPerPixel Lib "atmcd32d.dll" (ByVal state As Integer) As UInteger
...
Declare Function SetESDEvent Lib "atmcd32d.dll" (ByVal esdEvent As Integer) As UInteger
...
Declare Function SetFastKineticsStorageMode Lib "atmcd32d.dll" (ByVal mode As Integer) As UInteger
Declare Function SetFastKineticsTimeScanMode Lib "atmcd32d.dll" (ByVal rows As Integer, ByVal tracks As Integer, ByVal mode As Integer) As UInteger
...
Declare Function SetIsolatedCropModeType Lib "atmcd32d.dll" (ByVal type As Integer) As UInteger
Declare Function SetKeepCleanMode Lib "atmcd32d.dll" (ByVal mode As Integer) As UInteger
...
Declare Function SetOverTempEvent Lib "atmcd32d.dll" (ByVal tempEvent As Integer) As UInteger
...
Declare Function UpdateDDGTimings Lib "atmcd32d.dll" () As UInteger
...
Declare Function OA_IsPreSetModeAvailable Lib "atmcd32d.dll" (ByRef pcModeName As String) As UInteger
